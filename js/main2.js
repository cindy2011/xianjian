 ...
 function init() {
     ...
     var flipAngle = Math.PI, // 180度
         ...
         tileWidth = 512;
     var sides = [{
         url: "img/panorama.right.jpg", //right
         position: [-tileWidth, 0, 0],
         rotation: [0, rightAngle, 0]
     }, {
         url: "img/panorama.left.jpg", //left    
         position: [tileWidth, 0, 0],
         rotation: [0, -rightAngle, 0]
     }, {
         url: "img/panorama.top.jpg", //top
         position: [0, tileWidth, 0],
         rotation: [rightAngle, 0, Math.PI]
     }, {
         url: "img/panorama.bottom.jpg", //bottom
         position: [0, -tileWidth, 0],
         rotation: [-rightAngle, 0, Math.PI]
     }, {
         url: "img/panorama.front.jpg", //front
         position: [0, 0, tileWidth],
         rotation: [0, Math.PI, 0]
     }, {
         url: "img/panorama.back.jpg", //back
         position: [0, 0, -tileWidth],
         rotation: [0, 0, 0]
     }];
 ...
 function getTitle(num) {
     console.log("dataList:" + dataList + "," + num);
 ...
 $.get('data.json', function(data) {
     var id = $("#index2Title").attr("data-id");
